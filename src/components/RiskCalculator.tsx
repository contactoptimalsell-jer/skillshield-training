...
import { ChevronRight, ChevronLeft, X, Gauge, Clock, TrendingDown } from 'lucide-react'
import { Card } from './ui/Card'
import { Button } from './ui/Button'
import { calculateRiskScore, getRiskLevel, formatNumber } from '../lib/utils'
...
export const RiskCalculator: React.FC = () => {
  const { isCalculatorOpen, closeCalculator } = useApp()
  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={() => window.open('/calculator', '_blank', 'noopener,noreferrer')}
