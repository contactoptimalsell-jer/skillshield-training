...
-- Version simplifiée pour Clerk (RLS désactivé - sécurité côté API)
-- ============================================================================
...
-- Commentaires
COMMENT ON TABLE user_progress IS 'Suivi de progression utilisateur lié à Clerk via clerk_user_id';
COMMENT ON COLUMN user_progress.clerk_user_id IS 'ID utilisateur Clerk (obligatoire, unique)';
COMMENT ON COLUMN user_progress.completed_steps IS 'Liste JSONB des étapes complétées';
